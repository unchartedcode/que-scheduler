...
DROP FUNCTION que_scheduler_unschedule_jobs(schedule_name text);
DROP FUNCTION que_scheduler_schedule_jobs(schedule_name text);
DROP FUNCTION que_scheduler_reschedule_jobs(schedule_name text);
